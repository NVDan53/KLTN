...
const PostCard = ({ post }) => {
  ...
  <div className="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm mb-5 transition duration-500 ease-in-out transform hover:-translate-y-5 hover:shadow-2xl ">
    
      <img className="rounded-t-lg" src={thumbnail}  style={{ height: "200px", width: "100%", objectFit: "cover" }}alt="" />
    ...
    {categories.map((c) => (
      ...
      <a href="#">
        <h5 className="text-gray-900 font-bold text-2xl tracking-tight mb-2">{title && title.substring(0, 160)}</h5>
      </a>
      <p className="font-normal text-gray-700 mb-3">by {postedBy.name}</p>
