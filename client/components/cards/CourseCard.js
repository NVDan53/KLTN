...
const CourseCard = ({ course }) => {
  ...
  return (
    <Link href="/course/[slug]" as={`/course/${slug}`}>
      <div className="cursor-pointer m-1 max-w-sm bg-white px-2 pt-2 pb-2 rounded-xl border-solid border-2 transform hover:scale-90 transition duration-500 border-gray-200">
        ...
        <h1
          style={twoLineStyle}
          className="mt-2 text-gray-800 text-base font-bold cursor-pointer"
        >
          {name.substring(0, 60)}
        </h1>
        <div className="">
