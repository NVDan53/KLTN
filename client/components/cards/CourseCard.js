...
const CourseCard = ({ course }) => {
  ...
  return (
    ...
    <div className="cursor-pointer m-2 max-w-sm bg-white px-2 pt-2 pb-2 rounded-xl border-solid border-2 transform hover:scale-90 transition duration-500 border-gray-200">
      ...
      <h1 className="mt-2 text-gray-800 text-base font-bold cursor-pointer">{name.substring(0, 60)}</h1>
      <div className="">
          <div className="flex space-x-1 items-center">
            <p>By {instructor.name}</p>
          </div>
          <button className="mt-2 text-xl w-full text-white bg-indigo-600 py-2 rounded-xl">
