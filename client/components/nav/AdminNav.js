...
const AdminNav = () => {
  ...
  return (
    ...
    <nav className="mt-10">
    <Link href="/admin">
            <a className={`nav-link ${current === "/admin" && "active"}`} className="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
        ...
        <Link href="/admin/category">
          <a className={`nav-link ${current === "/admin/category" && "active"}`} className="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100" href="/tables">
        ...
        <Link href="/admin/issues">
          <a className={`nav-link ${current === "/admin/issues" && "active"}`} className="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100" href="/tables">
          <i class="fas fa-envelope h-6 w-6" style={{fontSize:"24px"}}></i>
