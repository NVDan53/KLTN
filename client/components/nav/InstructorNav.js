         ...
         <div className="min-h-screen side-ml-16 flex flex-col left-0 w-14 hover:w-64 md:w-64 bg-blue-900 h-full text-white transition-all duration-300 border-none z-10 sidebar">
             ...
             <ul className="flex flex-col py-4 space-y-1">
               ...
               <Link href="/instructor/course/create">
                <a  
                 ...
                 >
                   <span className="inline-flex justify-center items-center ml-4">
                   <i class="fas fa-video w-5 h-5 "style={{lineHeight:"20px"}}></i>
                   </span>
                   <span className="ml-2 text-sm tracking-wide truncate">Create Course</span>
          ...
          className={`nav-link ${
            current === "/instructor/revenue" && "active"
                 ...
                 >
                   <span className="inline-flex justify-center items-center ml-4">
                   <i class="fas fa-dollar-sign w-5 h-5 "style={{lineHeight:"20px"}}></i>
                   </span>
                   <span className="ml-2 text-sm tracking-wide truncate">
                   Revenue
                   </span>
