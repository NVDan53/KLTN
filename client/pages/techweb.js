    ...
    <>
      ...
      <section>
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-8 bg-gray-200">
              {" "}
              <img
                src="/images/abc.png"
                alt=""
            ...
            <div
              className="col-md-4 bg-gray-200"
              style={{ paddingRight: "80px" }}
            >
              <h1
                className="text-4xl font-semibold text-dark text-right"
                style={{
                  marginTop: "200px",
                  fontSize: "70px",
                  marginBottom: "30px",
              ...
              <h1
                className="text-4xl font-semibold text-dark text-right"
                style={{ fontSize: "70px", marginBottom: "40px" }}
              >
                with us
              </h1>

              <h1 className="text-xl text-dark text-right">
      ...
      <section>
        <div className="container mx-auto">
          <div className="rounded-lg bg-blue-300 text-white p-8 my-12 flex flex-col md:flex-row space-between items-center justify-between relative overflow-hidden">
            ...
            {/* RIGHT PART */}
            <div
              className="pt-8 md:pt-0 justify-center lg:ml-auto z-10"
              style={{ marginRight: "80px" }}
            >
              {/* Contribuer */}
              <Link href="/user/become-instructor">
                <a className="flex items-center px-8 py-4 text-center text-sm text-blue-300 font-bold uppercase bg-white font-display rounded-full transition duration-200">
            ...
            {/* DÉCORATION */}
            <div
              className="absolute bg-blue-400 opacity-60 w-96 h-96 -top-10 -right-16 md:w-[800px] md:h-[800px] md:left-[45%] md:top-[-150%] rounded-full shadow-2xl z-0"
