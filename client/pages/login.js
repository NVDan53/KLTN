    ...
    <div className="w-full h-100">
      ...
      <form className="mt-6" action="#" method="POST" onSubmit={handleSubmit}>
        ...
        <div className="mt-4">
          ...
          <input type="password" 
          name id placeholder="Enter Password" 
          minLength={6} 
        ...
        px-4 py-3 mt-6">{loading ? <SyncOutlined spin /> : "Login"}</button>
      </form>
      ...
      Need an account?{" "}
          <Link href="/register">
          <a href="#" className="text-blue-500 hover:text-blue-700 font-semibold">Create an
          account</a>
          </Link>
        </p>
