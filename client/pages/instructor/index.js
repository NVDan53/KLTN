  ...
  <div>
      ...
      <div className="inline-block w-full shadow rounded-lg overflow-hidden mb-4">
        ...
        courses.map((course) => (
            ...
            <tr key={course._id} className="xyz hover:bg-sky-100"style={{ cursor: "pointer" }}>
              ...
              <td className="px-4 py-4 border-b border-gray-200  text-sm">
                <p className="text-gray-900 whitespace-no-wrap">{course.lessons.length} Lessons</p>
              </td>
              <td className="px-4 py-4 border-b border-gray-200   text-sm">
                <p className="text-gray-900 whitespace-no-wrap">
              ...
              <td className="px-4 py-4 border-b border-gray-200   text-sm">
                <p className="text-gray-900 whitespace-no-wrap">
                <Badge count={course.paid ? course.price : "Free"}></Badge>
                </p>
              </td>
              <td className="px-4 py-4 border-b border-gray-200   text-sm">
              {course.published ? (
